...
def createDatasetSplit(params):
    ...
    if path.exists(filename[:-7]): 
        ...
        with open(params["post_id_division"], "r") as fp:
    ...
    # Test dataset is only ASR
    # TODO: change Test when hateMM test executed
    # if params["post_id_division"] != "/home/jinmyeong/code/hts/classifier/Data/hatemm_post_id_divisions.json":
    #     with open("/home/jinmyeong/code/hts/classifier/Data/Total_ASR_text_bert_softmax_1_128_2/test_data.pickle", "rb") as f:
    #         X_test = pickle.load(f)
    if params["bert_tokens"] == False:
